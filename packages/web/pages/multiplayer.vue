<template>
  <div class="main-menu pt-10">
    <Button :icon='true' :loading="loading" @click="create" small variant="blue">
      Spiel erstellen
    </Button>

    <hr class="mb-10 mt-10" />

    <GameSettings shade="blue" v-model="settings" :excluded="excludedSettings" :excluded-games="excludedGames"/>
