  ...
  <Panel class="mt-10">
    ...
    <template #content>
      ...
      <div class="pt-6 pb-3 flex justify-evenly">
        ...
        <a target='_blank'
           :href="`https://twitter.com/share?url=${link}&text=${text}&via=${referrer}&hashtags=${shareTags}`">
...
export default class Share extends Vue {
  ...
  get referrer() {
    return encodeURIComponent('geofind')
  }

  get shareTags() {
    return encodeURIComponent('geofind,playwithme,.io,game,geography')
  }
