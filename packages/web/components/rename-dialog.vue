<template>
  <Dialog :show="show">
    <Panel>
      <template #title>
        <div class="flex justify-between px-5 items-center justify-between w-full">
      ...
      <template #content>
        <Input ref='name' autofocus="true" class='bg-gray-100 my-3'  @change="setName()" v-model="name"/>
        <Box v-if='player' class="flex items-center flex-col justify-center content-center items-stretch">
