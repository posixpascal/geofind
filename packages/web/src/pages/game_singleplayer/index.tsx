...
const SingleplayerPage = ({match, room, roomActions, gameActions}) => {
    return <div>singleplayerpage</div>
};
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SingleplayerPage));
