...
export const FeedbackForm: React.FC<FeedbackFormProps> = ({
  ...
  return (
    <form onSubmit={submit} action="src/components#" className="relative">
      ...
      <div
        className="absolute bg-gray-100 rounded-b-lg border-t border-gray-200 inset-x-0 bottom-0 flex justify-between py-3 px-5
      ...
      >
                ...
                <>
                  ...
                  <div className="relative">
                    ...
                    <Transition
                      ...
                      leaveTo="opacity-0"
                    >
                      <Listbox.Options className="absolute z-10 mt-1 -ml-6 w-60 rounded-lg bg-white dark:bg-slate-700 py-3 text-base shadow ring-1 ring-black ring-opacity-5 focus:outline-none sm:ml-auto sm:w-64 sm:text-sm">
                        {moods.map((mood) => (
                          <Listbox.Option
                            key={mood.value}
                            className={({ active }) => `
        ...
        <div className="flex-shrink-0 flex  items-center gap-8 pb-2">
          ...
          <IconButton loading={loading}>Post</IconButton>
        </div>
      </div>
    </form>
  );
