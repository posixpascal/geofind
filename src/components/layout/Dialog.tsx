      ...
      <DialogUI as="div" className="relative z-10" onClose={setOpen}>
        ...
        <div className="fixed w-full inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <DialogUI.Panel className="relative transform rounded-lg bg-card px-4 pb-4 pt-5 text-left shadow-xl transition-all w-full sm:my-8 sm:w-full sm:max-w-sm md:max-w-md lg:max-w-lg sm:p-6">
