...
export default function ProfileSettingsPage() {
  ...
  const [colorSchemeTransition] = useTransition<ColorPaletteKey, any>(
  ...
  return (
    <Container>
      ...
      <div className={"grid grid-cols-1 md:grid-cols-2 mt-5 gap-8"}>
        {transition((style, setting) => (
          ...
          <animated.div
            ...
            key={setting.key}
            className={
              "bg-card will-change-transform theme-transition flex items-center justify-between rounded-xl p-5"
            }
          >
            ...
            <div
              className={"flex-grow whitespace-pre-wrap text-card-paragraph"}
            >
            ...
            <div className={"items-center flex gap-2 ml-4"}>
              ...
              <Switch
                ...
                onClick={(e) =>
                  toggleSetting(setting.key, !settings[setting.key])
                }
                className={`
                                    ${
      ...
      />
      <div
        className={"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-5 gap-8"}
      >
