...
const MenuItems_1 = require("@/components/layout/MenuItems");
const pick_1 = require("next/dist/lib/pick");
function IndexPage() {
    return (<Container_1.Container className={"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5 sm:gap-8"}>
      <MenuItems_1.MenuItems />
