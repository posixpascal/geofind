...
exports.createMapStyle = exports.COUNTRY_LABELS = void 0;
        ...
        layers: [
            {
                ...
                type: "background",
                paint: {
                    "background-color": hasDarkMode() ? "#103b6e" : "#D8F2FF",
                },
                filter: ["all"],
                layout: {
                    visibility: "visible",
...
exports.createMapStyle = createMapStyle;
